...
<head>
    ...
    <link rel="stylesheet" href="css/image_form.css">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <span class="navbar-text">
        <a class="nav-link active mylogout" aria-current="page" href="login.html">Logout</a>
      </span>
    </div>
  </div>
</nav>
...
<div class="container1">
  ...
  <div class="flex lhs-flex pb-5">
    ...
    <form class="submitform" action="UploadServ" method="post" enctype="multipart/form-data">
    
    
    <input type="text" class="form-control" placeholder="Admin Name" name="iname">     
    <label for="iname" class="form-label"></label> 
    
     <input type="text" class="form-control"  placeholder="Name" name="imgname">     
    <label for="imgname" class="form-label"></label>   
         
    <input type="text" class="form-control"  placeholder="Keywords" name="key">        
  ...
  <div class="flex rhs-flex">
    <div class="rhs">
    <div class="upload">
    <label for="image"><b>Image File</b></label> 
      <input type="file" required="required" class="form-control"  name="image">
    </div>
    
    <div class="description">
      <textarea name="des"  cols="30" rows="5" placeholder="Description"></textarea>
